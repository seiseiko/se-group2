...
first_names = ['的', '一', '是', '了', '我', '不', '人', '在', '他', '有', '这', '个', '上', '们', '来', '到', '时', '大', '地', '为',
                   ...
                   '腊', '妈', '变', '通', '师', '立', '象', '数', '四', '失', '满', '战', '远', '格', '士', '音', '轻', '目', '条', '呢',
                   ...
                   '官', '待', '究', '跟', '穿', '室', '易', '游', '程', '号', '居', '考', '突', '局', '哪', '费', '倒', '价', '图', '具',
                   ...
                   '展', '跳', '获', '艺', '六', '波', '察', '群', '皇', '段', '急', '庭', '创', '区', '奥', '器', '谢', '萼', '分', '否',
                   ...
                   '胜', '份', '汽', '右', '洋', '范', '床', '舞', '秘', '午', '登', '楼', '贵', '非', '责', '例', '追', '较', '职', '属',
                   ...
                   '乾', '坤']
enumlist=['普陀区', '静安区', '杨浦区', '黄浦区', '南汇区', '嘉定区', '徐汇区', '奉贤区', '长宁区', '闵行区']
endlist=['堂','药店','大药房','医药']
def getaddress():
    i=0
    res=random.randint(1,150)
    for line in open("F:\\软工\\se\\seapp\\interface\\sqlautomaking\\233.txt"):
        i=i+1
        if i==res:
            return str(line)
...
def makepharmacy():
        ...
        address=getaddress()+str(random.randint(1,1000))+'号'
        district=enumlist[random.randint(0,9)]
        name=first_names[random.randint(0,1000)]+first_names[random.randint(0,1000)]+endlist[random.randint(0,3)]
