# Generated by Django 2.0 on 2018-04-25 12:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deliveryid', models.IntegerField(blank=True, db_column='deliveryID', null=True)),
            ],
            options={
                'db_table': 'order',
                'managed': False,
        ...
        migrations.CreateModel(
            name='Pharmacy',
            fields=[
                ('idpharmacy', models.AutoField(primary_key=True, serialize=False)),
